...
using Track1Program = Track1::ManageVirtualMachineExtension.GeneratedTrack1Program;
using Track2Program = Track2::ManageVirtualMachineExtension.Program;

namespace ManageVirtualMachineExtension.Benchmarks
{
    [MemoryDiagnoser]
    [Orderer(SummaryOrderPolicy.FastestToSlowest)]
    [SimpleJob(launchCount: 1, warmupCount: 3, iterationCount: 10, invocationCount: 10)]
    public class VirtualMachineExtensionBenchmarks
    {
    ...
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            BenchmarkRunner.Run<VirtualMachineExtensionBenchmarks>(config);
        }
    }
}
