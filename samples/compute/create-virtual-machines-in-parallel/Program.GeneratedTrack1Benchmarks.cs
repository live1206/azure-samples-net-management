...
using Track1Program = Track1::CreateVirtualMachinesInParallel.GeneratedTrack1Program;
using Track2Program = Track2::CreateVirtualMachinesInParallel.Program;

namespace CreateVirtualMachinesInParallel.Benchmarks
{
    [MemoryDiagnoser]
    [Orderer(SummaryOrderPolicy.FastestToSlowest)]
    [SimpleJob(launchCount: 1, warmupCount: 3, iterationCount: 10, invocationCount: 10)]
    public class ParallelVirtualMachineBenchmarks
    {
    ...
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            BenchmarkRunner.Run<ParallelVirtualMachineBenchmarks>(config);
        }
    }
}
