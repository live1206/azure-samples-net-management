...
products:
- azure
description: "This code samples will show you how to create multiple virtual machines in parallel using Azure SDK for .NET."
urlFragment: compute-create-vms-in-parallel
---
# Getting started - Create Virtual Machines in parallel using Azure .NET SDK

This code sample will show you how to create multiple virtual machines in parallel using Azure SDK for .NET.
...
| SDK | Source | Project |
| --- | --- | --- |
| Track 1 generated | `Program.Track1Generated.cs` | `CreateVirtualMachinesInParallel.Track1Generated.csproj` |
...
```bash
cd samples/compute/create-virtual-machines-in-parallel
```
