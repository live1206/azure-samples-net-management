...
using Track1Program = Track1::ManageVirtualMachine.GeneratedTrack1Program;
using Track2Program = Track2::ManageVirtualMachine.Program;

namespace ManageVirtualMachine.Benchmarks
{
    [MemoryDiagnoser]
    [Orderer(SummaryOrderPolicy.FastestToSlowest)]
    [SimpleJob(launchCount: 1, warmupCount: 3, iterationCount: 10, invocationCount: 10)]
    public class ManageVirtualMachineBenchmarks
    {
    ...
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            BenchmarkRunner.Run<ManageVirtualMachineBenchmarks>(config);
        }
    }
}
