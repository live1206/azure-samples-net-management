...
BenchmarkDotNet's `Mean` is wall-clock elapsed time. It is not a direct process CPU-utilization measurement. If actual CPU consumption is required, add and document an appropriate CPU-time or hardware-counter diagnostic.
